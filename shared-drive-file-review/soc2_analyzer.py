...
AFTER_FILE = 'input/audit_Q1_2026_AFTER_CLEAN.csv'
...
def run_soc2_analysis():
    ...
    # Save the evidence
    remediated_df.to_csv('output/evidence_remediated_access.csv', index=False)
    print(f"-> Found {len(remediated_df)} revoked permissions. Saved to 'output/evidence_remediated_access.csv'")
